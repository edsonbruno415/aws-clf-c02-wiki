...
# Reflexões Sobre os Pilares do AWS Well-Architected Framework
...
1. [AWS Well-Architected: Aprenda, avalie e crie usando as melhores práticas de arquitetura](https://aws.amazon.com/pt/architecture/well-architected)
2. [AWS Well-Architected Framework (Documentação AWS)](https://docs.aws.amazon.com/pt_br/wellarchitected/latest/framework/welcome.html)